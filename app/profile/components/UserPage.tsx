...
import { ChallengeSelectComponent } from '@/app/profile/components/ChallengeSelect';
            ...
            {isLoading ? (
              ...
              <div className={`grid gap-3 ${isOwnProfile ? 'grid-cols-1 sm:grid-cols-2' : 'grid-cols-1'}`}>
                <Button
                  ...
                  onClick={() => {
                    router.push(`/dashboard/${userNickname}`);
                  }}
                >
                  대시보드
                </Button>
                {isOwnProfile && (
                  <Button
                    ...
                    onClick={() => {
                      router.push(`/profile/edit/${encodeURIComponent(editNickname)}`);
                    }}
                  >
                    프로필 편집
                  </Button>
